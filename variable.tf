...
variable "ami_id" {
  description = "ID of Ami to Provision"
  default     = "ami-04b70f"
}
...
variable "name" {
  description = "Name to pass to Name tags "
  default     = "Provisioned"
}
variable "bucket_name" {
  description = "Name to pass to Name tags "
  default     = "new-bucket-3"
...
variable "database_subnet_tag_1" {
  ...
  type        = string
  default     = "new_database_subnet_az_1a"
}
variable "database_subnet_tag_2" {
  description = "Tag for Private Subnet"
  type        = string
  default     = "new_database_subnet_az_1b"
}
